package zz.hujing.baseboot.core.generator;
...
public class CodeGenerator {
    ...
    public static void main(String[] args) {
        ...
        gc.setAuthor("hujing");
        gc.setOpen(false);
        gc.setEnableCache(false); //不自动生成二级缓存
        ...
        dsc.setUrl("jdbc:mysql://localhost:3307/oa?useUnicode=true&useSSL=false&characterEncoding=utf8");
//         dsc.setSchemaName("public");
        ...
        pcConfig.setParent("zz.hujing.baseboot")
                .setMapper("mapper")
                .setService("service")
...
//        strategy.setTablePrefix("tb_"); //设置表前缀
        strategy.setInclude("phone"); //生成表的名字
